...
@Disabled("Diagnóstico manual del flujo ACO heredado (procesa ~9.5M envíos). Ejecutar con -Dtest=PlanificadorCompletoTest cuando se necesite.")
class PlanificadorCompletoTest {
    ...
    void testProcesarTodosLosOrigenes() {
        ...
        if (resumen.costoPromedioExitosos > 0) {
